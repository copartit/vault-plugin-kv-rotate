...
func (b *kvRotateBackend) hashiCupsToken() *framework.Secret {
...
func (b *kvRotateBackend) tokenRevoke(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
...
func (b *kvRotateBackend) tokenRenew(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
