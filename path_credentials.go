...
// required, and named.
func pathCredentials(b *kvRotateBackend) *framework.Path {
...
// role exists.
func (b *kvRotateBackend) pathCredentialsRead(ctx context.Context, req *logical.Request, d *framework.FieldData) (*logical.Response, error) {
...
func (b *kvRotateBackend) createUserCreds(ctx context.Context, req *logical.Request, role *hashiCupsRoleEntry) (*logical.Response, error) {
